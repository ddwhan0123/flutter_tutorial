...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, R.style.fd_Loading);
    }

    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.fd_Loading);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.fd_loading, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(R.styleable.fd_loading_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.fd_loading_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.fd_loading_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.fd_loading_maxHeight, mMaxHeight);
        String indicatorName = a.getString(R.styleable.fd_loading_indicatorName);
        mIndicatorColor = a.getColor(R.styleable.fd_loading_indicatorColor, Color.WHITE);
    ...
    public void hide() {
        ...
        if (diff >= MIN_SHOW_TIME || mStartTime == -1) {
            ...
            if (!mPostedHide) {
                ...
                compositeSubscription.add(Observable.timer(MIN_SHOW_TIME - diff, TimeUnit.MILLISECONDS)
...
//                postDelayed(mDelayedHide, MIN_SHOW_TIME - diff);
    ...
    public void show() {
        ...
        if (!mPostedShow) {
            compositeSubscription.add(Observable.timer(MIN_DELAY, TimeUnit.MILLISECONDS)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Consumer<Long>() {
                        @Override
